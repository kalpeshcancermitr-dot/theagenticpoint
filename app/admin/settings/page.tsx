  ...
  return (
    <div className="p-6 lg:p-8 space-y-8">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="font-tight font-semibold text-2xl text-white">Settings</h1>
          <p className="text-sm text-brand-secondary mt-0.5">Manage site content and configuration</p>
        </div>
        <div className="flex items-center gap-3">
          <button
            onClick={fetchSettings}
            className="p-2.5 rounded-xl border border-brand-edge text-brand-secondary hover:text-white transition-all"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 px-5 py-2.5 rounded-xl accent-cta text-white text-sm font-semibold transition-all hover:scale-105 disabled:opacity-50"
          >
      ...
      {loading ? (
        ...
        <div className="space-y-5 max-w-2xl">
          {SETTINGS_GROUPS.map(({ title, icon: Icon, fields }) => (
            <div key={title} className="rounded-2xl border border-brand-edge surface-deep-sea/30 overflow-hidden">
              <div className="px-6 py-4 border-b border-brand-edge flex items-center gap-2">
          ...
          <div className="rounded-2xl border border-brand-edge surface-deep-sea/30 p-6 space-y-3">
