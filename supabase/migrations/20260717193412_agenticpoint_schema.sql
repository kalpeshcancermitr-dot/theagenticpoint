...
No authentication required — all data accessible by anon key.
...
- category: Project category (e.g., WhatsApp AI, CRM Automation)
- challenge: Description of the business challenge
- solution: Description of the AI solution built
...
- client_title: Client's job title / company
- content: Testimonial text
- rating: Star rating (1-5)
- is_published: Whether to display publicly
- created_at: Creation timestamp

## Security
- RLS enabled on all tables
- All policies use TO anon, authenticated (no sign-in required for this app)
- contact_requests and newsletter_subscribers: INSERT allowed for visitors, SELECT restricted
- portfolio_projects and testimonials: SELECT allowed publicly, write restricted
*/
