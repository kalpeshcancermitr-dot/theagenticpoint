...
## Tables
- site_settings: adds hero stat values/labels, calendly_url, whatsapp_number, social links

## Security
- No policy changes (table already allows anon SELECT, authenticated INSERT/UPDATE)
*/
