...
- id, title, slug, excerpt, content, category, status, cover_image_url, read_time, author, published_at, created_at, updated_at

### resources
Downloadable templates, guides, checklists, and tools.
- id, title, description, type, file_url, tags, download_count, is_published, created_at
...
## Alterations
### contact_requests
Add status column for lead tracking (new/reviewed/archived). Default 'new'. No data affected.
...
- contact_requests: authenticated UPDATE + SELECT all allowed
*/
